...
public class OpsService extends Service {
	...
	public OpsService(Config conf, String serviceUrl, String params) {
		super(conf, ServiceType.InternalService, serviceUrl, params);
	}

	public static void register() {
		Config.registerService(OpsService.class.getName(), "ops");
	}
	
	@Override
	public Object getNewObject(String name, String params) {
		return new OpsObject(conf, this, name, params);
	}
